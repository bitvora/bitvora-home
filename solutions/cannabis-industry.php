...
<head>
   ...
   $pageURL = "https://signet.bitvora.com/solutions/cannabis-industry";
    ...
    <main class="w-full mb-8 pb-8">
        <section class="justify-between items-center lg:px-6 mb-6 lg:mb-2 container mx-auto w-full">
            <div class="relative w-full justify-center text-center flex flex-col-reverse lg:flex-col">
                <div
                    ...
                    <img src="/assets/cannabis.svg"
                        class="w-full h-full object-contain solutions-header-image hidden md:flex" />
                    <img src="/assets/cannabis-mobile.svg" class="w-full h-full object-fill md:hidden" />
                </div>
                ...
                <div id="hero-section"
                    ...
                    <p
                        ...
                        Offer secure, low cost and instant payments in your cannabis business by accepting Bitcoin over
                        the lightning network. Enjoy the benefits of open, permissionless payments that keep your
                        business going without risk of deplatforming.
                    </p>
        ...
        <section
            ...
            <h4
                ...
                How Bitcoin Improves Payment
                Processing for Cannabis Companies
            </h4>
            ...
            <div
                ...
                <div class="col-span-3 w-full px-2 lg:px-1">
                    ...
                    <p
                        ...
                        Your customers will love the instant speed during checkout and knowing they will not be blocked
                        by their financial institution for their cannabis purchases. As a business you can rest assured
                        that transactions will not be reversed, making it easier to manage your cash flow.
                    </p>
                </div>
            ...
            <div class="flex flex-col lg:grid lg:grid-cols-5 w-full lg:w-11/12 mx-auto lg:mb-12 lg:pb-12">
                ...
                <div class="col-span-3 w-full">
                    ...
                    <p
                        ...
                        payments made with bitcoin can only be made by the bearer and are irreversible. This protects
                        your customers from unwanted purchases with their cards and gives you peace of mind that
                        payments you receive belong to you.
                    </p>
                </div>
            </div>
            ...
            <div
                ...
                <div class="col-span-3 w-full px-2 lg:px-1">
                    ...
                    <p
                        class="text-light font-medium mb-6 pb-6 text-[14px] sm:text-[14px] lg:text-[16px] 2xl:text-[24px] text-center lg:text-left">
                        Bitcoin advocates enthusiastically support businesses that accept bitcoin as a form of payment.
                        Enjoy the benefits of free marketing for your business simply by accepting a superior form of
                        payment. Get listed on many popular websites that showcase businesses that are joining the
                        bitcoin ecosystem.
                    </p>
                </div>
