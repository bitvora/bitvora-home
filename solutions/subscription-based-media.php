...
<head>
   ...
   $pageURL = "https://signet.bitvora.com/solutions/subscription-based-media";
    ...
    <main class="w-full mb-8 pb-8">
            ...
            <div class="relative w-full justify-center text-center flex flex-col-reverse lg:flex-col">
                ...
                <div id="hero-section"
                    ...
                    <p
                        ...
                        Open the door to new, flexible payments for your subscription-based media products. Offer fast,
                        flexible payment options for your customers and affiliates with Bitcoin and the Lightning
                        Network.
                    </p>
        ...
        <section
            ...
            <h4
                ...
                How Bitcoin Brings New Opportunities
                for Subscription-Based Media
            </h4>
