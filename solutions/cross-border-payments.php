    ...
    <main class="w-full mb-8 pb-8">
            ...
            <div class="relative w-full justify-center text-center flex flex-col-reverse lg:flex-col">
                ...
                <div id="hero-section"
                    ...
                    <p
                        ...
                        With the advent of Bitcoin and the Lightning Network, transferring money across international
                        borders has completely changed. The old fashioned way of transferring money digitally through
                        SWIFT bank wire payments, or physically using foreign exchange currency providers is no longer
                        necessary.
                    </p>
        ...
        <section
            ...
            <h4
                ...
                How Bitcoin Has Changed The Game For
            ...
            <div
                ...
                <div class="col-span-3 w-full px-2 lg:px-1">
                    ...
                    <p
                        ...
                        Traditional international payment methods like SWIFT can take several business days to finally
                        reach their destination. With Bitcoin, payments can be delivered instantly and become spendable,
                        without any potential hang-ups or additional steps needed for your customers or suppliers.
                        Attract new international customers, suppliers or users by offering a much faster option for
            ...
            <div class="flex flex-col lg:grid lg:grid-cols-5 w-full lg:w-11/12 mx-auto lg:mb-12 lg:pb-12">
                ...
                <div class="col-span-3 w-full">
                    ...
                    <p
                        ...
                        conversion fees. Bitcoin is money without borders. Bitcoin is completely permissionless and as
                        long as you have internet access (even partially), you can send and receive Bitcoin payments.
                    </p>
                </div>
            </div>
            ...
            <div
                ...
                <div class="col-span-3 w-full px-2 lg:px-1">
                    ...
                    <p
                        class="text-light font-medium mb-6 pb-6 text-[14px] sm:text-[14px] lg:text-[16px] 2xl:text-[24px] text-center lg:text-left">
                        Small payments are not practical when sending through traditional methods like a bank wire, as
                        it can be costly and time consuming to submit a bank wire. The Bitcoin lightning network allows
                        you to send and receive payments less than $0.01, for the cost of a tiny fraction of this
                        amount. You can now pay suppliers, partners and users in less than a minute, for small invoices,
                        allowing you the flexibility of offering smaller, quicker payments.
                    </p>
                </div>
            ...
            <div class="flex flex-col lg:grid lg:grid-cols-5 w-full lg:w-11/12 mx-auto lg:mb-12 lg:pb-12">
                ...
                <div class="col-span-3 w-full px-2 lg:px-1">
                    ...
                    <p
                        ...
                        irreversible. There is no chargeback risk. This protects you when receiving payment for bookings
                        and
            ...
            <div
                ...
                <div class="col-span-3 w-full px-2 lg:px-1">
                    ...
                    <p
                        class="text-light font-medium mb-6 pb-6 text-[14px] sm:text-[14px] lg:text-[16px] 2xl:text-[24px] text-center lg:text-left">
                        Conducting business across borders can get expensive as you have to deal with sending and
                        receiving payments with hefty fees, either through services such as Paypal or through bank
                        wires. Accepting payments with Bitvora are as low as 0.3%, which is up to 90%-95% less expensive
                        than traditional international money services.
                    </p>
                </div>
