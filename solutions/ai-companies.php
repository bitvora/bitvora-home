            ...
            <div class="relative w-full justify-center text-center flex flex-col-reverse lg:flex-col">
                ...
                <div id="hero-section"
                    ...
                    <p
                        ...
                        Unlock innovative new business models like per per inference or agent to agent payments, lower
                        your costs with instant, low fee payments powered by Bitcoin and the Lightning network. Join
                        thousands of AI companies making the switch to Bitcoin today.
                    </p>
