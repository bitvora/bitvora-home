...
<head>
   ...
   $pageURL = "https://signet.bitvora.com/solutions/ecommerce-platform";
    ...
    <main class="w-full mb-8 pb-8">
            ...
            <div class="relative w-full justify-center text-center flex flex-col-reverse lg:flex-col">
                ...
                <div id="hero-section"
                    ...
                    <p
                        ...
                        Increase your sales and profit margins by accepting the lower cost payment option with the
                        Bitcoin and Lightning networks. Reach a new audience of enthusiastic customers who will love
                        supporting your online store.
                    </p>
        ...
        <section
            ...
            <h4
                ...
                Improving the E-Commerce Checkout
            ...
            <div
                ...
                <div class="col-span-3 w-full px-2 lg:px-1">
                    ...
                    <p
                        ...
                        Remove the friction in the checkout process by displaying a QR code for payments instead of the
                        traditional credit card experience and reach customers who don’t have access to credit cards or
                        where credit cards aren’t available.
                    </p>
                </div>
