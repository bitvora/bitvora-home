...
<head>
    <?php
    $pageTitle = "Bitcoin Payments for SaaS Companies | Bitvora";
...
<body>
    ...
    <main class="w-full mb-8 pb-8">
            ...
            <div class="relative w-full justify-center text-center flex flex-col-reverse lg:flex-col">
                ...
                <div id="hero-section"
                    ...
                    <h1
                        ...
                        Bitcoin Payments for SaaS Companies
                    </h1>
        ...
        <section
            ...
            <div
                ...
                <div class="col-span-2 w-full flex justify-center items-center mb-2 pb-2 lg:mb-0 lg:pb-0">
                    ...
                    <img src="/assets/rates-shake-mobile.svg" class="solutions-image md:hidden" />
                </div>
            </div>
        ...
        $faqItems = [
            [
                'question' => 'What are the advantages of Bitcoin Payments for SaaS Companies?',
        ...
        <?php
        $header = "Power your payments with Bitcoin and Bitvora";
