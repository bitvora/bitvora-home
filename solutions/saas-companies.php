        ...
        <section class="justify-between items-center lg:px-6 mb-6 lg:mb-2 container mx-auto w-full">
            <div class="relative w-full justify-center text-center flex flex-col-reverse lg:flex-col">
                <div
                    ...
                    <img src="/assets/saas-mobile.svg" class="w-full h-full object-fill md:hidden" />
                </div>
                ...
                <div id="hero-section"
                    ...
                    <p
                        ...
                        Unlock innovative new business models and lower your costs with instant, low cost payments
                        powered by Bitcoin and the Lightning network. Join thousands of SaaS companies making the switch
                        to Bitcoin today.
                    </p>
