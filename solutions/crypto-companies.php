...
<head>
   ...
   $pageURL = "https://signet.bitvora.com/solutions/crypto-companies";
            ...
            <div class="relative w-full justify-center text-center flex flex-col-reverse lg:flex-col">
                ...
                <div id="hero-section"
                    ...
                    <p
                        ...
                        As time has gone on, more and more cryptocurrencies have launched and competed for users’
                        mindshare. However, Bitcoin still remains the original, largest and highest volume
                        cryptocurrency demanded by the market. While Bitcoin is often misunderstood to be too slow and
                        expensive to operate with a high throughput business or with low transaction sizes, with the
                        advent of the Lightning Network, Bitcoin can be used in manners that are often faster and
                        cheaper than most other cryptocurrencies. With Bitvora we enable you to use Bitcoin to its full
                        potential in your crypto company.
                    </p>
