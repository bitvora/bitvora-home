...
<head>
    <?php
    $pageTitle = "Bitcoin Payments for Digital Content Platforms | Bitvora";
    ...
    <main class="w-full mb-8 pb-8">
        <section class="justify-between items-center lg:px-6 mb-6 lg:mb-2 container mx-auto w-full">
            <div class="relative w-full justify-center text-center flex flex-col-reverse lg:flex-col">
                <div
                    ...
                    <img src="/assets/digital-content-platform.svg"
                        class="w-full h-full object-contain solutions-header-image hidden md:flex" />
                    <img src="/assets/digital-content-platform-mobile.svg" class="w-full h-full object-fill md:hidden" />
                </div>
        ...
        <section
            ...
            <h4
                ...
                How Bitcoin Brings New Opportunities for Digital Content Platforms
            </h4>
