        ...
        <section
            ...
            <div
                ...
                <div class="col-span-3 w-full px-2 lg:px-1">
                    ...
                    <p
                        ...
                        The bitcoin lightning network allows you to send payments less than $0.01, enabling you to
                        collect donations of any amount.
                    </p>
                </div>
            ...
            <div
                ...
                <div class="col-span-3 w-full px-2 lg:px-1">
                    ...
                    <p
                        class="text-light font-medium mb-6 pb-6 text-[14px] sm:text-[14px] lg:text-[16px] 2xl:text-[24px] text-center lg:text-left">
                        Bitcoin advocates enthusiastically support charities that accept bitcoin as a form of payment.
                        Enjoy the benefits of free marketing for your charity or NGO simply by accepting a superior form
                        of payment. Get listed on many popular websites that showcase organizations that are joining the
                        bitcoin ecosystem.
                    </p>
                </div>
