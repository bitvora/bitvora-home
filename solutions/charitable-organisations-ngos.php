    ...
    <main class="w-full mb-8 pb-8">
        <section class="justify-between items-center lg:px-6 mb-6 lg:mb-2 container mx-auto w-full">
            <div class="relative w-full justify-center text-center flex flex-col-reverse lg:flex-col">
                <div
                    ...
                    <img src="/assets/ngo.svg"
                        class="w-full h-full object-contain solutions-header-image hidden md:flex" />
                    <img src="/assets/ngo-mobile.svg" class="w-full h-full object-fill md:hidden" />
                </div>

                <div id="hero-section"
                    class="w-full px-6 md:w-9/12 lg:w-10/12 xl:w-8/12 relative mx-auto mt-[150px] sm:mt-[120px] md:mt-[140px] lg:mt-2 xl:mt-2 2xl:mt-2 pt-2 sm:pt-[40px] md:pt-2 lg:pt-2 xl:pt-2 2xl:pt-2 justify-center text-center">
                    <h1
                        ...
                        Bitcoin Payments for Charities & NGOs
                    </h1>
                    ...
                    <p
                        ...
                        Increase your donation volume and simplify your cross border payments with the power of the Bitcoin and Lightning network. Start accepting donations as low as $0.01 today!.
                    </p>
        ...
        <section
            ...
            <h4
                ...
                How Bitcoin Changes Payments for SaaS Companies
            </h4>
            ...
            <div
                ...
                <div class="col-span-3 w-full px-2 lg:px-1">
                    ...
                    <p
                        ...
                        Micropayments aren’t possible on traditional payment processors because of the high base fee. The bitcoin lightning network allows you to send payments less than $0.01, enabling you to collect donations of any amount.
                    </p>
                </div>

                <div class="col-span-2 w-full flex justify-center items-center mb-2 pb-2 lg:mb-0 lg:pb-0">
                    <img src="/assets/donations-right.svg" class="solutions-image hidden md:flex" />
                    <img src="/assets/donations-mobile.svg" class="solutions-image md:hidden" />
                </div>
            </div>
            ...
            <div class="col-span-3 w-full px-2 lg:px-1">
                ...
                <p
                    class="text-light font-medium mb-6 pb-6 text-[14px] sm:text-[14px] lg:text-[16px] 2xl:text-[24px] text-center lg:text-left">
                    Reach more new supporters by offering your donation amounts in more modest amounts. Remove the friction in the checkout process by displaying a QR code for payments instead of the traditional credit card experience.
                </p>
            </div>
            </div>
        </section>
        ...
        <?php 
            $faqItems = [
                [
                    'question' => 'What are the advantages of Bitcoin Payments for Charities?', 
                    'answer' => 'Bitcoin provides a faster, safer, more private and lower cost form of payment that improves the experience for both your users and your organization. Remove the friction traditionally associated with sign ups and subscriptions using micro donations with Bitcoin.'
                ],

                [
                    'question' => 'How Do Bitcoin Payments Protect My Supporter’s Privacy?', 
                ...
                [
                    'question' => 'Will Accepting Bitcoin Payments Attract more supporters to my charity?',
                    'answer' => 'Yes! There are dozens of websites that will promote your charity or NGO to the bitcoin community when you start accepting bitcoin payments. Many bitcoin enthusiasts specifically seek out organizations that align with their values and will gladly support and promote you when you start accepting Bitcoin.',
                ],
        ...
        $text = "Are you ready to lower your transaction costs, broaden your customer base and join the future of online payments? Sign up for a free account today or contact a Bitvora sales representative for more information on how Bitcoin payments can power your charity today!";
