...
<meta property="og:title" content="Bitvora | <?php echo isset($pageTitle) ? htmlspecialchars($pageTitle, ENT_QUOTES, 'UTF-8') : 'Bitcoin & Lightning API'; ?>" />
...
<meta name="twitter:title" content="Bitvora | <?php echo isset($pageTitle) ? htmlspecialchars($pageTitle, ENT_QUOTES, 'UTF-8') : 'Bitcoin & Lightning API'; ?>" />
...
<title>Bitvora | <?php echo isset($pageTitle) ? htmlspecialchars($pageTitle, ENT_QUOTES, 'UTF-8') : 'Bitcoin & Lightning API'; ?></title>
